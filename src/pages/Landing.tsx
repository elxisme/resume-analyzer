          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-24">
            <div className="text-center">
              ...
              <p className="text-base sm:text-lg lg:text-xl text-white/90 mb-6 sm:mb-8 max-w-3xl mx-auto leading-relaxed px-4">
                Your resume analyzer, scanning resumes that get lost in the ATS shuffle.<br />
                Discover compatibility scores, keyword matches, and get a tailored resume & cover letter.
              </p>
